 ...
 */
public class clsDatos_TrnsfrHead {
    int Imagenes;
    ...
    public clsDatos_TrnsfrHead(int imagenes, String docEntry, String absentry, String docNum, String docDate, String tipo, String comentarios, String cardcode) {
        Imagenes = imagenes;
        DocEntry = docEntry;
        AbsEntry= absentry;
        DocNum = docNum;
