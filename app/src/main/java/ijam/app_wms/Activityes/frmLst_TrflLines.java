...
public class frmLst_TrflLines extends AppCompatActivity {
    ...
    public void CargaLineas(String sDocEnt){
        ...
        try{
            ...
            oConn = new clsOCFG();  //Objeto oConn es la conexión???
    ...
    //Muestra los datos que se obtuvieron y los pone en forma de lista
        ...
        try
        {
            ...
            oLstLines.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    oAddOnHead.putExtra("OrderEntry", oDatos.getCantSur()); //******Agregado*****
                    oAddOnHead.putExtra("Ubicacion", oDatos.getUbicacion()); //******Agregado*****
    ...
    //Que hace ese array??? ----Agrega los datos o los lista????
